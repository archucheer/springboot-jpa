...
//            return "{\"access_token\":\"19_FVM7LB0isQF1uYbdHORnRQi8voTDVEPyrpJhLwOUUbQg4rMpSFvC56Ke5zlrAuRDP_KwF4rvnlKVImur-sCB7_SEDzu1iWNZSZH4cbjpJh_WzguaMKmDgeR8yFwKFL2sGK3VRzuk_8xKAA1qQJPbAEAATZ\",\"expires_in\":7200}";
//        }
//        if("jsapi_ticket".equals(key)){
//            return "{\"errcode\":0,\"errmsg\":\"ok\",\"ticket\":\"HoagFKDcsGMVCIY2vOjf9otMwdpRzSXcHOIRjW9s_BOq9lz0uRl06WelCUjPv569m2bYhPvRYJKPDYMuFN5A0g\",\"expires_in\":7200}";
//        }
        String redisData=key==null?null:valueOperations.get(key);
        if(redisData==null){
            throw new ResultException(ResultCode.ERROR_OF_NOSQL, "redis中未获取到数据");
        }
        return redisData;
    }
    ...
    public boolean set(String key,Object value,long time){
        try {
            if(time>0){
                valueOperations.set(key, JSON.toJSONString(value), time, TimeUnit.SECONDS);
            }else{
                set(key, value);
            }
            return true;
